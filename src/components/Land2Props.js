...
const Land2Props = ({icon , header , text}) => {
  return (
    <div className="flex flex-col bg-slate-300 dark:bg-slate-600 w-40 h-40 md:w-48 rounded-lg md:h-48 items-center justify-center gap-y-3">
      ...
      <p className="dark:text-white text-violet-500 text-sm">{text}</p>
    </div>
  );
};
